...
class Version
{
     ...
     * @var string
     */
    public $product = 'Crowdfunding Files';
     ...
     * @var string
     */
    public $releaseDate = '23 February, 2017';
     ...
     * @var string
     */
    public $url = '<a href="http://itprism.com/help/95-crowdfunding-documentation-faq?start=1#crowdfunding-files" target="_blank">Crowdfunding Files</a>';
     ...
     * @var string
     */
    public $requiredPrismVersion = '1.18';
