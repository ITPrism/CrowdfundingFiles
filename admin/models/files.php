...
class CrowdfundingFilesModelFiles extends JModelList
{
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            $this->getState(
                'list.select',
                'a.id, a.title, a.filename, a.filedata, a.section, a.user_id, a.project_id, ' .
                'b.title AS project, ' .
                'c.name AS user'
            )
        );
        $query->from($db->quoteName('#__cffiles_files', 'a'));
