...
?>
<form action="<?php echo JRoute::_('index.php?option=com_crowdfundingfiles&view=files'); ?>" method="post"
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    ...
                    <input type="text" name="filter_search" id="filter_search" class="hasTooltip"
                           placeholder="<?php echo JText::_('COM_CROWDFUNDINGFILES_SEARCH_IN_TITLE'); ?>"
                           value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
                           title="<?php echo JText::_('COM_CROWDFUNDINGFILES_SEARCH_IN_TITLE_TOOLTIP'); ?>"/>
                </div>
